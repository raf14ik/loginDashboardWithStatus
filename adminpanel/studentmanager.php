                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                     ...
                     <a href="?stid=<?php echo $stu['eid']; ?>" onclick="return confirm('Are You Sure ?');"><i class="ni ni-button-power text-warning"></i></a>
                    </td>
                  </tr>
                  <!-- Modal status -->
                                  ...
                                  <div class="input-group input-group-alternative">
                                    <div class="input-group-prepend">
                                      ...
                                      <div class="modal-body">
                                        ...
                                        <div class="form-check form-check-inline">
                                          <input class="form-check-input" name="stt" type="checkbox" id="inlineCheckbox1" value="2">
