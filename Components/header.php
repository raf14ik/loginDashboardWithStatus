<?php include('inc/main.php');
      ...
      $udata = GetStudent($conn,$studentid); 
   // checking user login 
      if($studentid==NULL)
      {
        echo"<script> window.setTimeout(function() { window.location.href = './login.php'; }, 0);</script>";
      }
   //logout
      if($_GET['logout']==1)
      {
...
">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link " href="studentmanager.php">
              <i class="ni ni-single-02 text-red"></i> Etudiants
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="#">
              <i class="ni ni-bullet-list-67 text-blue"></i>  Cours
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="#">
 ...
 <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="dashboard.php"><?php echo $softwarename; ?></a>
