<?php include('inc/main.php');
      ...
      if (file_exists($filename)){         
          ...
          echo"<script> window.setTimeout(function() { window.location.href = './install/index.php'; }, 0);</script>";
      }
      ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container mt--8 pb-5">
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <?php
                  if (!empty($_POST))
                  {
                      ...
                      $loginnow =  StudentLogin($conn,$email,$password,$rem);
                      if($loginnow=='success')
                      {
          ...
          <div class="row mt-3">
            <div class="col-6">
              <a href="createAcc.php" class="text-light"><small>Créer votre compte</small></a>
            </div>
